export default async function handler(request, response) {
  ...
  const clientId = process.env.NAVER_MAP_CLIENT_ID || process.env.NAVER_DIRECTION_CLIENT_ID;
  const clientSecret = process.env.NAVER_MAP_CLIENT_SECRET || process.env.NAVER_DIRECTION_CLIENT_SECRET;
